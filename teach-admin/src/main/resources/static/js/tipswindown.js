...
function tipsWindown(title,content,width,height,drag,time,showbg,cssName,backcall) {
	...
	if(showWindown == true) {
		var simpleWindown_html = new String;
			...
			simpleWindown_html += "<div id=\"windown-title\"><h2 style=\"margin-top:5px\"></h2><span id=\"windown-close\">关闭</span></div>";
			simpleWindown_html += "<div id=\"windown-content-border\"><div id=\"windown-content\"></div></div>"; 
			simpleWindown_html += "</div>";
			$("#content").append(simpleWindown_html);
			show = false;
	}
	...
	var _version = 7.0;//$.browser.version;
	if ( _version == 6.0 ) {
