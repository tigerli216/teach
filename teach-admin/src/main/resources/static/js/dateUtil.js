    ...
    */
     ...
     */
     ...
     this.yestoday = function(date) {
    	 ...
    	 var yday = new Date();       
    	 yday.setTime(yesterday_milliseconds);       
    	 
    	 return yday;  
     }
     
     /**
      * 获取相差天数，返回yyyy-MM-dd HH:mm
      * date 日期对象
      * type 类型：day，hour
      */
     this.differDate = function(date, type, num) {
    	 var difMill = 0;	// 相差毫秒数
    	 if (type == "day") {
    		 difMill = num * 1000 * 60 * 60 * 24;
    	 } else if (type == "hour") {
    		 difMill = num * 1000 * 60 * 60;
    	 }
    	 var newDate = new Date();
    	 newDate.setTime(date.getTime() + difMill);
    	 
    	 var month = newDate.getMonth() > 8 ? (newDate.getMonth() + 1) : '0' + (newDate.getMonth() + 1);
    	 ...
    	 return newDate.getFullYear() + "-" + month + "-" + day + " " + hours;
     }
